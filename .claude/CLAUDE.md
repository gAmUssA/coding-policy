...
This repo IS `gamussa/coding-policy`. The rule files below are the source-of-truth plugin content, imported directly so the maintainer always reads and edits the live versions, never a vendored `.tessl/plugins/` copy.
